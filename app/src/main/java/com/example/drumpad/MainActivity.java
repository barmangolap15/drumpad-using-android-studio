...
public class MainActivity extends AppCompatActivity {
    ...
    private int sound00;
    private int fly;
    private int gritty_sputter;
    private int razor_buzz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fly = sp.load(getApplicationContext(),R.raw.fly,1);
        gritty_sputter = sp.load(getApplicationContext(),R.raw.gritty_sputter,1);
        razor_buzz = sp.load(getApplicationContext(),R.raw.razor_buzz,1);
    ...
    public void playsound4 (View v) {
        sp.play(sound4,1.0f,1.0f,0,0,5f);

    }
    public void playsound5 (View v) {
        sp.play(sound5,1.0f,1.0f,0,0,5f);

    }
    public void playsound6 (View v) {
        sp.play(sound6,1.0f,1.0f,0,0,5f);

    }
    public void playsound7 (View v) {
        sp.play(sound7,1.0f,1.0f,0,0,5f);

    }
    public void playsound8 (View v) {
        sp.play(sound8,1.0f,1.0f,0,0,5f);

    }
    public void playsound9 (View v) {
        sp.play(sound9,1.0f,1.0f,0,0,5f);

    }

    public void playsound10(View view) {
        sp.play(fly,1.0f,1.0f,0,0,5f);
    }

    public void playsound11(View view) {
        sp.play(gritty_sputter,1.0f,1.0f,0,0,5f);
    }

    public void playsound12(View view) {
        sp.play(razor_buzz,1.0f,1.0f,0,0,5f);
    }
}